...
const RidePopUp = ({ setRidePopUpPanel, setConfirmRidePopUpPanel }) => {
  return (
    <div>
      ...
      <h3 className="text-2xl font-semibold  pl-3">New Ride Avaliable!</h3>
      ...
      <div className="flex gap-2 flex-col justify-between items-center ">
        ...
        <button
          ...
          className="w-full bg-green-600 rounded text-white font-semibold flex justify-center items-center py-2"
        >
          Accept
        </button>
        <button
          ...
          className="w-full bg-gray-200 rounded text-gray-700 font-semibold flex justify-center items-center py-2"
        >
          Ignore
        </button>
      </div>
